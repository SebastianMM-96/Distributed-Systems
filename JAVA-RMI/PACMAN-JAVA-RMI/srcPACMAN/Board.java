	...
	public class Board extends JPanel implements ActionListener {
	    ...
	    Dimension d; //Dimension del tablero 
	    Font smallfont = new Font("Monospaced", Font.BOLD, 16);

	    FontMetrics fmsmall, fmlarge;
	    Image ii;
	    Color dotcolor = new Color(0, 192, 192);
	    Color mazecolor;
	    ...
	    //Propiedades del pacman y los fantasmas
	    ...
	    //Cargamos las imagenes de nuestro juego
	    Image ghost;
	    ...
	    public void ShowIntroScreen(Graphics2D g2d) {
	        ...
	        String s = "Presione S para iniciar el juego, Y Q para salir.";
